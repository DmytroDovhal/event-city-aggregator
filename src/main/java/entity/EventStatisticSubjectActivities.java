...
public class EventStatisticSubjectActivities extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1721965683228763730L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventStatisticSubjectActivities\",\"namespace\":\"entity\",\"fields\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"past7daysCount\",\"type\":\"int\"},{\"name\":\"past7daysUniqueCount\",\"type\":\"int\"},{\"name\":\"past30daysCount\",\"type\":\"int\"},{\"name\":\"past30daysUniqueCount\",\"type\":\"int\"}]}");
   ...
   */
  public static entity.EventStatisticSubjectActivities.Builder newBuilder() {
    return new entity.EventStatisticSubjectActivities.Builder();
  }
   ...
   * @return A new EventStatisticSubjectActivities RecordBuilder
   */
  public static entity.EventStatisticSubjectActivities.Builder newBuilder(entity.EventStatisticSubjectActivities.Builder other) {
    return new entity.EventStatisticSubjectActivities.Builder(other);
  }
   ...
   * @return A new EventStatisticSubjectActivities RecordBuilder
   */
  public static entity.EventStatisticSubjectActivities.Builder newBuilder(entity.EventStatisticSubjectActivities other) {
    return new entity.EventStatisticSubjectActivities.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventStatisticSubjectActivities>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(entity.EventStatisticSubjectActivities.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(entity.EventStatisticSubjectActivities other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder setPast7daysCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder clearPast7daysCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder setPast7daysUniqueCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder clearPast7daysUniqueCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder setPast30daysCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder clearPast30daysCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder setPast30daysUniqueCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatisticSubjectActivities.Builder clearPast30daysUniqueCount() {
