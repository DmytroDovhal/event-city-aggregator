...
public class EventStatistic extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<entity.EventStatisticSubject> subjects;
   ...
   */
  public EventStatistic(java.util.List<entity.EventStatisticSubject> subjects) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: subjects = (java.util.List<entity.EventStatisticSubject>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<entity.EventStatisticSubject> getSubjects() {
    return subjects;
  }
   ...
   */
  public void setSubjects(java.util.List<entity.EventStatisticSubject> value) {
    this.subjects = value;
  }
   ...
   */
  public static entity.EventStatistic.Builder newBuilder() {
    return new entity.EventStatistic.Builder();
  }
   ...
   * @return A new EventStatistic RecordBuilder
   */
  public static entity.EventStatistic.Builder newBuilder(entity.EventStatistic.Builder other) {
    return new entity.EventStatistic.Builder(other);
  }
   ...
   * @return A new EventStatistic RecordBuilder
   */
  public static entity.EventStatistic.Builder newBuilder(entity.EventStatistic other) {
    return new entity.EventStatistic.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventStatistic>
    ...
    private java.util.List<entity.EventStatisticSubject> subjects;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(entity.EventStatistic.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(entity.EventStatistic other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.subjects)) {
        this.subjects = data().deepCopy(fields()[0].schema(), other.subjects);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatistic.Builder setSubjects(java.util.List<entity.EventStatisticSubject> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public entity.EventStatistic.Builder clearSubjects() {
      subjects = null;
    ...
    public EventStatistic build() {
      try {
        ...
        record.subjects = fieldSetFlags()[0] ? this.subjects : (java.util.List<entity.EventStatisticSubject>) defaultValue(fields()[0]);
        return record;
